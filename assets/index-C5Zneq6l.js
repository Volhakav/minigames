...
`,H=()=>{const e=document.createElement("div");e.className="auth-backdrop auth-backdrop--hidden",e.innerHTML=`
  ...
  `;const c=document.createElement("div");return c.className="game-card__stat game-card__stat--likes",c.innerHTML=`
