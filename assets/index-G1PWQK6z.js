...
`,H=()=>{const e=document.createElement("div");e.className="auth-backdrop auth-backdrop--hidden",e.innerHTML=`
  ...
  `,s.append(c,i),a.append(r,s),t.append(o,a),t},V=e=>{const t=document.createElement("section");t.className="carousel-section";const o=document.createElement("header");o.className="carousel-section__header";const n=document.createElement("div");n.className="carousel-section__title-wrapper";const a=document.createElement("span");a.className="carousel-section__badge";const r=document.createElement("h2");r.className="carousel-section__title",r.textContent="New Games",n.append(a,r);const s=document.createElement("nav");s.className="carousel-section__nav",s.setAttribute("aria-label","Carousel Navigation");const c=document.createElement("button");c.type="button",c.className="carousel-section__btn carousel-section__btn--prev",c.setAttribute("aria-label","Previous slide"),c.innerHTML=`
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
      <line x1="19" y1="12" x2="5" y2="12"></line>
      <polyline points="12 19 5 12 12 5"></polyline>
    </svg>
  `;const i=document.createElement("button");i.type="button",i.className="carousel-section__btn carousel-section__btn--next",i.setAttribute("aria-label","Next slide"),i.innerHTML=`
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
      <line x1="5" y1="12" x2="19" y2="12"></line>
      <polyline points="12 5 19 12 12 19"></polyline>
    </svg>
  `,s.append(c,i),o.append(n,s);const p=["cat-mail-co","islanders-new-shores","vacation-cafe-simulator","winter-burrow","shelve-the-potions"],m=[],h=new Map(e.map(l=>[l.slug,l]));for(const l of p){const u=h.get(l);u&&(m.push(u),h.delete(l))}for(const l of h.values())m.push(l);const d=document.createElement("div");d.className="carousel-section__track-container";const g=document.createElement("div");g.className="carousel-section__track";const v=[];for(const l of m){const u=document.createElement("div");u.className="carousel-section__slide";const w=O(l);u.append(w),g.append(u),v.push(u)}d.append(g),t.append(o,d);let y=2;const _=()=>{const l=window.innerWidth<=1024,u=v.length;for(const[w,b]of v.entries()){b.classList.remove("carousel-section__slide--wide","carousel-section__slide--standard","carousel-section__slide--compact","carousel-section__slide--hidden");let f=(w-y)%u;f>u/2&&(f-=u),f<-u/2&&(f+=u),f===0?b.classList.add("carousel-section__slide--wide"):Math.abs(f)===1?b.classList.add(l?"carousel-section__slide--compact":"carousel-section__slide--standard"):!l&&Math.abs(f)===2?b.classList.add("carousel-section__slide--compact"):b.classList.add("carousel-section__slide--hidden")}};return c.addEventListener("click",()=>{const l=v.length;y=(y-1+l)%l,_()}),i.addEventListener("click",()=>{const l=v.length;y=(y+1)%l,_()}),window.addEventListener("resize",_),_(),t},K=e=>{const t=e.match(/[A-Z]/g);return t&&t.length>=2?t.slice(0,2).join(""):e.slice(0,2).toUpperCase()},X=e=>e.toLocaleString("en-US"),$=e=>e>=1e3?`${(e/1e3).toFixed(1)}K`:e.toString(),Q=e=>{const t=document.createElement("section");t.className="leaderboard-section";const o=document.createElement("header");o.className="leaderboard-section__header";const n=document.createElement("div");n.className="leaderboard-section__title-wrapper";const a=document.createElement("span");a.className="leaderboard-section__badge";const r=document.createElement("h2");r.className="leaderboard-section__title",r.innerHTML=`
